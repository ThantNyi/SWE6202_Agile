"""
Django settings for smr_website project.
...
SECRET_KEY = 'django-insecure-j6)l=uwe3gqh&=nldljd3jhnpm8^@yqt7!$z=^1p7+6-3_1q$6'
...
WSGI_APPLICATION = 'smr_website.wsgi.application'
